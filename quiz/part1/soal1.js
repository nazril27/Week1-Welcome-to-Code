...
let nama = "", peran = "", respon = "";

if (nama){
    if(peran === ""){
        respon = `Pilih peranmu untuk memulai game!`;
    } else {
        if (peran === "Ksatria"){
            ...
            respon = "tapi kayaknya kamu jadi bot aja ya, peran yang kamu pilih gaada"; 
        }
    }
} else {
    respon = "Nama wajib diisi";
}
